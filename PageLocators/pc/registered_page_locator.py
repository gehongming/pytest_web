...
class RegisteredPageLocator:
    ...
    business_license = (
        By.XPATH,
        '//div[text()="营业执照"]/following-sibling::div/div/div/div/div/span/div[@class="ant-upload ant-upload-select ant-upload-select-picture-card"]')
    # 选择医疗许可证
    choose_medicallicense = (By.XPATH, '//input[@type="checkbox"]')
    # 医疗许可证
    medical_license = (
        By.XPATH,
        '//p[text()="上传医疗器械经营许可证："]/following-sibling::div/div/div/div/div/span/div[@class="ant-upload ant-upload-select ant-upload-select-picture-card"]')
    # 下一步
