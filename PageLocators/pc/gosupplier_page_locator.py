...
class GosupplierPageLocator:
    ...
    search_product_name = (
        By.XPATH,
        '//input[@ng-model="condition.productName"]')

    # 仓库列表全选框  3
    all_check = (
        By.XPATH,
        '//div/div/div/span/input[@class="ng-pristine ng-untouched ng-valid ng-empty"]')

    # 在售列表全选框  3
    all_check_zaishou = (
        By.XPATH,
        '//div/div/span/input[@class="ng-pristine ng-untouched ng-valid ng-empty"]')
