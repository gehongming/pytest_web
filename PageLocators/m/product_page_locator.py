...
class ProductPageLocator:
    ...
    blh_count = (
        By.XPATH,
        '//span[text()="军绿色"]/parent::div/following-sibling::div[@class="action-wrap"]/a[text()="+"]')

    # 镜片sku
    jp_count = (
        By.XPATH,
        '//span[text()="-17.00"]/parent::div/following-sibling::div[@class="list-value"]/span[text()="+0.00"]/parent::div/following-sibling::div[@class="action-wrap"]/a[text()="+"]')
